...
* **Popovaitė, Wood et al. (2026)** Notes from the field: Experiences and challenges for conducting fieldwork in glacial environments. *Nordia Geographical Publications*.
* **Sun, Wood, et al. (2025)** Unveiling large-scale velocity characteristics of rock glaciers in the Tibet-Pamir-Karakoram region using InSAR. *Int. Journal of Applied Earth Observation*.
* **Wood, Bolch and Streeter (2025)** Insights from feature tracking of optical satellite data for studying rock glacier kinematics. *Front. Earth Sci.*
